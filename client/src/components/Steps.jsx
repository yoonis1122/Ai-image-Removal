...
const Steps = () => {
  return (
    <div className='mx-4 lg:mx-44 py-20 xl:py-40'>
        ...
        <div className='flex items-start gap-4 flex-wrap mt-16 xl:24 justify-center'>
            
            <div className='flex items-start bg-white gap-4 border drop-shadow-md p-7 pb-10 rounded hover:scale-105 transition-all duration-500'>
