...
<p className='my-6 text-[15px] text-gray-500'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Exercitationem, nihil repellendus.<br className='max-sm:hidden'/> Fugiat, id. Animi aspernatur, illo incidunt ratione ullam, est dolores repellat deleniti nesciunt voluptas quo sapiente, dolorum harum eaque!</p>
<div>
    ...
    <p className='text-white text-sm'>uload your image</p>
        </label>
