...
const Result = () => {
      ...
      <div className='bg-white rounded-lg px-8 py-6 drop-shadow-sm'>
        ...
        <div className='flex flex-col sm:grid grid-cols-2 gap-8'>
          ...
          <div className='flex flex-col'>
            <p className='font-semibold text-gray-600 mb-2'>backfround removed</p>
  ...
  <div className='border-4 border-violet-600 rounded-full h-12 w-12 border-t-transparent animate-spin'></div>
      ...
      <div className='flex justify-center sm:justify-end items-center flex-wrap gap-4 mt-6'>
        <button className='px-8 py-2.5 text-violet-600 border text-sm border-violet-600 rounded-full hover:scale-105 transition-all duration-700'>Try another image</button>
